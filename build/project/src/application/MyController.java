...
public class MyController implements Initializable {
	...
	public void initialize(URL location, ResourceBundle resources) {
		...
		media_text.setVisible(false);

		media_button.setTranslateX(application.Main.stage.getWidth() - 100);
		media_button.setTranslateY(application.Main.stage.getHeight() - 45);
		
		media_slider.setTranslateY(application.Main.stage.getHeight() - 20);
		media_slider.setTranslateX(10);
		media_slider.setPrefWidth(application.Main.stage.getWidth() - 20);
		
		System.out.println(media_button.getTranslateX());
		System.out.println(media_button.getTranslateY());
		...
		media_button.setOnMouseClicked((click) -> {
			...
			if (media_player != null) { media_player.pause(); }
			...
			AccessController.doPrivileged(new PrivilegedAction<Void>() {
				public Void run() {
		    		...
		    		media_media =  new Media(file.toURI().toString());
		       		...
		       		else if (application.Main.stage.getWidth() > 1279 && application.Main.stage.getHeight() > 719) {
		       			view_media_width = 1280;
		       			view_media_height = 720;
		       		}
		       		else if (application.Main.stage.getWidth() > 959 && application.Main.stage.getHeight() > 539) {
		       			view_media_width = 960;
		       			view_media_height = 540;
		       		}
		       		else if (application.Main.stage.getWidth() > 639 && application.Main.stage.getHeight() > 359) {
		       		...
		       		*/
		       		...
		       		media_view.setTranslateX((application.Main.stage.getWidth() - media_view.getFitWidth()) / 2);
		       		media_view.setTranslateY(10);
		       		
		       		media_text.setTranslateX(media_view.getTranslateX() + 10);
			...
			media_text.setText("00:00:00/00:00:00");
			
			media_button.setTranslateY(application.Main.stage.getHeight() - 65);
			media_slider.setVisible(true);
			media_view.setVisible(true);
			media_text.setVisible(true);
